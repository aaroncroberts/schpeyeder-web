...
goog.provide('schpeyeder.web.components.driver.controllers.DriverCtrl');
...
goog.scope(function(){
	 ...
	 * @constructor
	 */
	schpeyeder.web.components.driver.controllers.DriverCtrl = function($scope, driverDataService) {
